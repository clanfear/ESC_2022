...
# Next Section {background-image="img/ben-sp-fD4AwrWv4t8-unsplash-crop.jpg" background-opacity=0.3}
...
# Many Sections {background-image="img/clay-banks-nsAn3nSW5T0-unsplash.jpg" background-opacity=0.3}

# Extra Section {background-image="img/joel-mott-s-rsM-AktbA-unsplash.jpg" background-opacity=0.3}