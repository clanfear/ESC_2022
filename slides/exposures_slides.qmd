...
Percentage of homicides using a gun has increased over time; more gun homicides now than in crime peak of early 1990s.
:::
...
::: notes
We'll be focusing mostly on race here today. Next session will discuss cohorts.
:::
...
![](img/ncgvr.svg){.absolute bottom=75 right=50 width="200"}
:::
...
tibble(
  ...
  scale_x_continuous(limits = c(-9, 28)) +
