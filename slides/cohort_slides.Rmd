...
# The Changing Risks of Exposure to Gun Violence in Chicago {background-image="img/dark/50/stephan-cassara-KnAIsBuitGg-unsplash.jpg" background-opacity="0.3"}
...
hom_rate_df %>%
  ...
  geom_line(size = 1) +
  labs(x = NULL, y = "Homicides per 100,000", title = "Homicide Rates in Chicago") +
...
#  {background-image="img/dark/70/max-bender-yb7Yg3Rv7WA-unsplash.jpg" background-opacity="0.1"}
...
cohort_age_hom %>%
  ...
  labs(x = "Cohort member age", y = "Homicide Rate", title = "Contexts of Violence") +
  theme(panel.grid = element_blank(),
...
# Lifecourse Exposures to Gun Violence {background-image="img/dark/50/ozzie-stern-dkwJLowVvl4-unsplash.jpg" background-opacity="0.3"}

---

# {background-image="img/dark/70/ozzie-stern-dkwJLowVvl4-unsplash.jpg" background-opacity="0.1"}
...
hazard_margin <- c(4,4,4,0)

par(family = plot_font, bg = NA, cex = 1.75, mar = hazard_margin)
...
title(main = "Been shot", col.main = "white", adj = 0, family = plot_title_font, font = 2, cex.main = 2)
text(x = rep(0, 5),
     adj = 0,
     font = c(2, 1, 1 ,1, 1),
...
# grid(nx = NULL, ny = NA, lty = "dashed", col = "grey90", lwd = 1)
title(xlab = "Age", ylab = "Cumulative Probability",  col.lab = "white")
title(main = "Seen shot", col.main = "white", adj = 0, family = plot_title_font, font = 2, cex.main = 2)
text(x = rep(0, 5),
     adj = 0,
     font = c(2, 1, 1 ,1, 1),
...
# grid(nx = NULL, ny = NA, lty = "dashed", col = "grey90", lwd = 1)
title(xlab = "Age", ylab = "Cumulative Probability",  col.lab = "white")
title(main = "Seen shot", col.main = "white", adj = 0, family.main = plot_title_font, font.main = 2, cex.main = 2)
text(x = rep(0, 5),
     adj = 0,
     font = c(1, 1, 1 ,2),
...
# Risk and Protective Factors {background-image="img/dark/50/clay-banks-nsAn3nSW5T0-unsplash.jpg" background-opacity="0.3"}

---

# {background-image="img/dark/70/clay-banks-nsAn3nSW5T0-unsplash.jpg" background-opacity="0.1"}
...
map_dfr(c("seen_shot", "been_shot"), ~ get_spt_estimates(spt_base_models, .x, zval = 1.96)) %>%
  ...
  ggplot(aes(x = estimate, y = term)) + 
    ...
    labs(y = NULL, x = "Hazard Ratio", title = "Estimates", subtitle = NULL) +
...
# Takeaways {background-image="img/dark/50/joel-mott-s-rsM-AktbA-unsplash.jpg" background-opacity="0.1"}
...
# Appendix {background-image="img/dark/50/ben-sp-fD4AwrWv4t8-unsplash-crop.jpg" background-opacity="0.3"}

---

# {background-image="img/dark/70/ben-sp-fD4AwrWv4t8-unsplash-crop.jpg" background-opacity="0.3"}
